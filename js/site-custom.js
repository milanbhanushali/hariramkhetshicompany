  ...
  'use strict'
	...
	$(window).scroll(function() {
        if ($(this).scrollTop() > 50) {
            ...
            $('#myImage').removeClass('displayBlock');
            $('#myImage').addClass('displayNone');

            $('#myH2').removeClass('displayNone');
            $('#myH2').addClass('displayBlock');
        } else {
            $('.header-fullpage').removeClass('fixed');
            $('#myH2').removeClass('displayBlock');
            $('#myH2').addClass('displayNone');

            $('#myImage').removeClass('displayNone');
            $('#myImage').addClass('displayBlock');
        }
    });
